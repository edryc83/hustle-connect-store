import { Package, LayoutDashboard, Settings, LogOut, ClipboardList, BarChart3, Moon, Sun, Palette } from "lucide-react";
...
const navItems = [
  ...
  { title: "Design Studio", url: "/dashboard/share", icon: Palette },
