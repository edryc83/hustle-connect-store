...
export const COUNTRIES: Country[] = [
  ...
  { name: "Eritrea", code: "ER", flag: "🇪🇷", phone: "+291", cities: ["Asmara", "Keren", "Massawa", "Assab", "Mendefera"] },
  { name: "Guinea", code: "GN", flag: "🇬🇳", phone: "+224", cities: ["Conakry", "Nzérékoré", "Kankan", "Kindia", "Labé"] },
  { name: "Guinea-Bissau", code: "GW", flag: "🇬🇼", phone: "+245", cities: ["Bissau", "Bafatá", "Gabú"] },
  { name: "Equatorial Guinea", code: "GQ", flag: "🇬🇶", phone: "+240", cities: ["Malabo", "Bata", "Ebebiyín"] },
  { name: "Chad", code: "TD", flag: "🇹🇩", phone: "+235", cities: ["N'Djamena", "Moundou", "Sarh", "Abéché"] },
  { name: "Central African Republic", code: "CF", flag: "🇨🇫", phone: "+236", cities: ["Bangui", "Bimbo", "Berbérati", "Carnot"] },
  { name: "Comoros", code: "KM", flag: "🇰🇲", phone: "+269", cities: ["Moroni", "Mutsamudu", "Fomboni"] },
  { name: "Djibouti", code: "DJ", flag: "🇩🇯", phone: "+253", cities: ["Djibouti City", "Ali Sabieh", "Tadjoura", "Obock"] },
  { name: "Seychelles", code: "SC", flag: "🇸🇨", phone: "+248", cities: ["Victoria", "Anse Boileau", "Bel Ombre"] },
  { name: "Cape Verde", code: "CV", flag: "🇨🇻", phone: "+238", cities: ["Praia", "Mindelo", "Santa Maria", "Espargos"] },
  { name: "São Tomé & Príncipe", code: "ST", flag: "🇸🇹", phone: "+239", cities: ["São Tomé", "Santo Amaro", "Neves"] },
  { name: "Madagascar", code: "MG", flag: "🇲🇬", phone: "+261", cities: ["Antananarivo", "Toamasina", "Antsirabe", "Mahajanga", "Fianarantsoa"] },
  { name: "Mauritania", code: "MR", flag: "🇲🇷", phone: "+222", cities: ["Nouakchott", "Nouadhibou", "Kiffa"] },
  { name: "Gabon", code: "GA", flag: "🇬🇦", phone: "+241", cities: ["Libreville", "Port-Gentil", "Franceville", "Oyem"] },
  { name: "Republic of Congo", code: "CG", flag: "🇨🇬", phone: "+242", cities: ["Brazzaville", "Pointe-Noire", "Dolisie"] },
