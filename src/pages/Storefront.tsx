...
function ProductDetailView({
  ...
  const buildWhatsAppMessage = () => {
    ...
    const productPageUrl = `https://afristall.com/${profile.store_slug}/${product.id}`;
    const lines: string[] = [productPageUrl, ``];
...
const StorefrontInner = () => {
  ...
  // Apply store accent color as CSS custom property
  useEffect(() => {
    if (!profile) return;
    const accent = (profile as any).accent_color;
