export const INSPIRATIONS = [
  {
    ...
    "prompt": "Vivid purple gradient with horizontal motion-blur light streaks, hero subject mid-action, bold white headline with selected words highlighted in yellow, small logo top-center, contact bar pinned to bottom with thin gold rule."
  },
  {
    "id": "navy-glow",
    "image": "/design-templates/navy-glow.jpeg",
    "prompt": "Deep navy dotted background, hero product floating encircled by a glowing neon ring of sparkles, headline split into yellow + white words, bold yellow pill CTA, white rounded contact bar at the bottom."
  },
  {
    "id": "mono-editorial",
    "image": "/design-templates/mono-editorial.png",
    "prompt": "Sleek dark almost-black background with subtle vignette, product hero on the right razor-sharp, huge condensed white headline on the left, accent thin underline, pill price chip, pill WhatsApp CTA."
  },
  {
    "id": "navy-curve",
    "image": "/design-templates/navy-curve.jpeg",
    "prompt": "Deep navy background with a soft cyan curved swoosh, hero product on the right, bold split yellow/white headline on the left, yellow pill CTA, white rounded contact bar at the bottom."
  },
  {
    "id": "campaign-bold",
    "image": "/design-templates/campaign-bold.jpeg",
    "prompt": "Dark dramatic background with green radial glow behind a hyper-real 3D hero, big bold white headline with one phrase highlighted in lime, white rounded panel at the bottom holding a green pill CTA + social handles."
  },
  {
    "id": "dark-lime-tech",
    "image": "/design-templates/dark-lime-tech.jpeg",
    "prompt": "Dark green-to-black gradient, hero subject lit with lime green rim light, two-line headline where one half is lime and the other half is silver, small caps eyebrow line above, glassy rounded contact bar at the bottom."
  },
  {
    "id": "big-month",
    "image": "/design-templates/big-month.jpeg",
    "prompt": "Massive single hero word as the centerpiece, subject photo overlapping the word, small yellow rounded-pill labels floating around, soft dark background, glassy contact bar at the bottom."
  },
  {
    "id": "exclusive-class",
    "image": "/design-templates/exclusive-class.jpeg",
    "prompt": "Dark background, small outlined 'EXCLUSIVE' eyebrow pill, gigantic stacked white headline with one word in lime green, soft body text, hero subject bottom-right with floating chat-bubble CTA card."
  },
  {
    "id": "teal-corporate",
    "image": "/design-templates/teal-corporate.jpeg",
    "prompt": "Teal/cyan geometric chevron shapes overlaying a real lifestyle photo, bold white headline with one accent-colored highlighted word, small body paragraph, pill website CTA, small logo bottom-right."
  },
  {
    "id": "green-editorial",
    "image": "/design-templates/green-editorial.jpeg",
    "prompt": "Deep forest green background with a subtle dotted texture, oversized lime-green editorial headline at the top wrapping over multiple lines, hero product floating in a hand bottom-center, small wordmark bottom-right."
  },
  {
    "id": "green-key-ai",
  ...
  },
  {
    ...
    "prompt": "Vivid orange background tiled with faint repeated wordmark watermark, tiny social icon row top-left, huge stacked white rounded headline with mixed weights, short two-line subline, slim outlined white pill CTA with arrow, hero subject lounging on the right side, small LOGO + handle row at the bottom."
  },
  {
  ...
  },
  {
    ...
    "prompt": "Deep dark maroon background with subtle repeated wordmark texture, small white script eyebrow line, massive orange editorial headline with one word in white serif italic beneath, hero product centered with floating orange glowing 3D icon cubes around it, tiny wordmark at the bottom."
  },
  {
    "id": "new-month-april",
  ...
  },
  {
    ...
    "prompt": "Black background with floating glassy green 3D crystal shards, small logo + wordmark top-left, two-line bold headline where line 1 is white and line 2 is lime green (same words/structure), hero subject centered, lime green pill CTA on the left mid, bottom strip with social icon row and @handle in lime."
  },
  {
    "id": "trevix-vr",
  ...
  },
  {
    ...
    "prompt": "Full-frame image containing a large, tilted product shot positioned centrally, angled to the right. The background is a solid, vibrant orange. There are two lists of benefits, stacked vertically: one on the left of the product and one on the right. Each benefit is accompanied by a small icon and is encased in an elongated, rounded rectangular bubble with a thin outline. Decorative orange slice elements are placed in the corners of the background. The text blocks are clean and sans-serif, and the overall aesthetic is bright and clean."
  },
  {
    "id": "tpl-082",
